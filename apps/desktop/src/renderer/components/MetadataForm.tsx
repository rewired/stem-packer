    ...
    <div className="space-y-4">
      ...
      <div className="grid gap-4 md:grid-cols-2">
        <label className="form-control" htmlFor="metadata-title">
          <span className="label-text sr-only" id="metadata-title-label">
          ...
          <input
            ...
            placeholder={t('metadata_field_title')}
        ...
        <label className="form-control" htmlFor="metadata-artist">
          <span className="label-text sr-only" id="metadata-artist-label">
          ...
          <input
            ...
            type="text"
            className="input input-bordered input-sm"
            placeholder={t('metadata_field_artist')}
        ...
        <label className="form-control" htmlFor="metadata-album">
          <span className="label-text sr-only" id="metadata-album-label">
          ...
          <input
            ...
            type="text"
            className="input input-bordered input-sm"
            placeholder={t('metadata_field_album')}
        ...
        <label className="form-control" htmlFor="metadata-bpm">
          <span className="label-text sr-only" id="metadata-bpm-label">
          ...
          <input
            ...
            type="text"
            className="input input-bordered input-sm"
            placeholder={t('metadata_field_bpm')}
        ...
        <label className="form-control" htmlFor="metadata-key">
          <span className="label-text sr-only" id="metadata-key-label">
          ...
          <input
            ...
            type="text"
            className="input input-bordered input-sm"
            placeholder={t('metadata_field_key')}
        ...
        <label className="form-control" htmlFor="metadata-license">
          <span className="label-text sr-only" id="metadata-license-label">
          ...
          <input
            ...
            type="text"
            className="input input-bordered input-sm"
            placeholder={t('metadata_field_license')}
